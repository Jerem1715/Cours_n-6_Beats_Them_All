...
public class CameraPlayer : MonoBehaviour
{
    ...
    {
        //Récupérer la position X du player sur l'écran
        float screenPosPlayer = Camera.main.WorldToScreenPoint(player.transform.position).x;

        //On impose des limites au placement du player sur l'écran, et si elles sont dépassée la caméra se met à suivre le joueur
